document.addEventListener("DOMContentLoaded", () => {
  ...
  const btnTheme = document.getElementById("themeToggler");
  ...
  function displayMode() {
    if (mode === "darkMode") {
        document.documentElement.style.setProperty('--secondary-color', darkMode.secondaryColor);
        document.documentElement.style.setProperty('--text-color', darkMode.textColor);
        document.documentElement.style.setProperty('--border-color', darkMode.borderColor);
        document.documentElement.style.setProperty('--modal-color', darkMode.modalColor);
        btnTheme.innerHTML = darkMode.icon;
    } else {
        document.documentElement.style.setProperty('--secondary-color', lightMode.secondaryColor);
        document.documentElement.style.setProperty('--text-color', lightMode.textColor);
        document.documentElement.style.setProperty('--border-color', lightMode.borderColor);
        document.documentElement.style.setProperty('--modal-color', lightMode.modalColor);
        btnTheme.innerHTML = lightMode.icon;
    }
  }
});
